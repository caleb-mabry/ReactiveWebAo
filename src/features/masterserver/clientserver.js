...
export const clientServer = createSlice({
    ...
    setAreaPlayerCount: (state, action) => {
      state.areas[action.payload.areaNumber].playerCount = action.payload.playerCount
    },
    ...
    setCharacterAvailablility: (state, action) => {
       state.characters[action.payload.index]['availability'] = action.payload.availability
    }
    },
  })
  
  // Action creators are generated for each case reducer function
  export const { setEmotes, setOptions, setAreaPlayerCount,setBackground,setAssetUrl,  setTimers, addCharacter, setCharacterAvailablility, addMessage, addOocMessage, setAreaNames, setClient, setCharacterId } = clientServer.actions
